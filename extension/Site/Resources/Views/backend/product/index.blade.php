...
@section('content')
    ...
    @include('partials.content_header',['title' => 'Products','breadcrumb' => (!empty($node) ? $node : null) ])
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="{!! route('reactor.business.product.import',$node_id) !!}" class="btn btn-flat btn-warning">Import</a>

                    <a href="{!! route('reactor.business.product.create',$node_id) !!}" class="btn btn-flat btn-danger">Create</a>
                    ...
                    <table class="table table-striped">
                        ...
                        @foreach($nodes as $node)
                            <tr>
                                ...
                                <td class="text-right">
                                    @include('Site::backend.product.partials.options',['node' => $node])
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
