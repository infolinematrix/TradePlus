<div class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-right">
        ...
        <li>
            <a href="{!! route('reactor.business.product.edit',[$node->getKey(),$node->translate(locale())->getKey()]) !!}"><i class="fa fa-edit"></i> {!! __('Edit Post') !!}</a>
        </li>
        <li>
            {!! delete_form(
                route('reactor.business.product.destroy', $node->getKey()),
                'Delete') !!}
        </li>
    </ul>
