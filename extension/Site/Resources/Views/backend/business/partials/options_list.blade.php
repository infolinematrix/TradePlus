        ...
        <ul class="list-group">
            ...
            @endif
                ...
                <li class="list-group-item">
                    ...
                    <a href="{{ route('reactor.business.photo', $node->getKey()) }}">
                        {{ __('Add Logo & Cover') }}</a>
                </li>

                <li class="list-group-item">
                    <i class="fa fa-briefcase"></i>
                    <a href="{{ route('reactor.business.service', $node->getKey()) }}">
                        {{ __('Business Services') }}</a>
                </li>

                <li class="list-group-item">
                    <i class="fa fa-shopping-cart"></i>
                    <a href="{{ route('reactor.business.product', $node->getKey()) }}">
                        {{ __('Business Products') }}</a>
                </li>
