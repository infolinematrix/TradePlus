...
use ReactorCMS\Http\Controllers\Traits\ModifiesPermissions;
...
class UsersController extends ReactorController
{
    ...
    public function updatePassword(Request $request, $id)
    {
        ...
        $this->validateForm('ReactorCMS\Html\Forms\Users\PasswordForm', $request);
    ...
    public function associateRole(Request $request, $id)
    {
        ...
        $this->validateForm('ReactorCMS\Html\Forms\Roles\AddRoleForm', $request);
