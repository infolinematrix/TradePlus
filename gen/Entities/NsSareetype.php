...
class NsSareetype extends NodeSourceExtension {

    /**
     * The fillable fields for the model.
     */
    protected $fillable = ['saree_length', 'saree_blouse', 'saree_fabric', 'saree_color'];
    ...
    {
        return ['saree_length', 'saree_blouse', 'saree_fabric', 'saree_color'];
    }
